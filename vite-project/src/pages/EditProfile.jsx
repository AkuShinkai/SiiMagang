...
function EditProfil() {
    ...
    return (
        <div className='max-sm m-5 rounded-xl flex flex-col shadow-md mb-6 mt-4 px-5 py-5 bg-white'>
            ...
            <img src={profileData.profile_picture ? profileData.profile_picture : profil} alt="Profile" className='w-32 h-32 rounded-full mx-auto ring-2 mb-5 ring-orange-300 p-1' />
                <input ref={img}
                    hidden
                    accept="image/*"
                    type="file"
